export default {
  ...
  'models.form.partialoffload.tips':
    '在启用 CPU 卸载后，GPUCluster 优先将尽可能多的层加载到 GPU 上，以最大化性能。如果 GPU 资源有限，则某些层将被卸载到 CPU 上，只有在没有 GPU 可用时，才会完全使用 CPU 进行推理。',
  ...
  'model.form.ollamatips':
    '提示：以下为 GPUCluster 预设的 Ollama 模型，请选择你想要的模型或者直接在右侧表单 【{name}】 输入框中输入你要部署的模型。',
  'models.sort.name': '名称',
  'models.sort.size': '大小',
  ...
  'models.form.backendVersion.tips':
    '固定指定版本以保持后端在 GPUCluster 升级过程中的稳定性',
